...
function grabHudElements() {
    ...
    const allElements = [
        ...
        projectileSpeedValueEl, projectileMassValueEl, cameraZoomValueEl,
    ...
    const elementIds = [ 
        ...
        'hud_projectileSpeedValue', 'hud_projectileMassValue', 'hud_cameraZoomValue',
...
export function updateHUD(currentState) {
    ...
    updateValueSpan(bhEventHorizonValueEl, settings.bhEventHorizonRadiusPx);
