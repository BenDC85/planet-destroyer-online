...
export const CRATER_SCALING_C = 1.0e-1; // UPDATED - Was 5e-2
export const KE_TO_MASS_EJECT_ETA = 3e+1;
export const BH_ENERGY_MULTIPLIER = 2.0;
export const DIRECT_CLICK_DESTRUCTION_MASS_THRESHOLD_FACTOR = 0.1;
...
export const BH_DRAG_ZONE_MULTIPLIER = 5.0;    // UPDATED - Was 2.5
export const BH_DRAG_COEFFICIENT_MAX = 0.100;  // UPDATED - Was 0.075
...
// --- Chunk Behavior ---
export const CHUNK_PHYSICS_TOTAL_FRAMES = 180;
export const CHUNK_PROXIMITY_REMOVAL_RADIUS_PX = 50;
export const CHUNK_PROXIMITY_REMOVAL_RADIUS_SQ_PX = CHUNK_PROXIMITY_REMOVAL_RADIUS_PX * CHUNK_PROXIMITY_REMOVAL_RADIUS_PX;
export const CHUNK_TARGETED_REMOVAL_SPEED_PX_FRAME = 60;
...
export const CHUNK_DEFAULT_BASE_SIZE_RANDOM_RANGE = 12;
...
export const PROJECTILE_DEFAULT_MASS_KG = 50;  // UPDATED - Was 5
export const PROJECTILE_MIN_MASS_KG = 1;

// --- Planet Generation Constants ---
// Note: Planet generation will primarily be server-side, but client might use some for display or defaults
...
export const defaultProjectileSpeed = 600.0; // HUD Value - UPDATED - Was 100.0
export const defaultProjectileMass = PROJECTILE_DEFAULT_MASS_KG; // Now 50kg
...
export const defaultBHDragZoneMultiplier = BH_DRAG_ZONE_MULTIPLIER; // Now 5.0
export const defaultBHDragCoefficientMax = BH_DRAG_COEFFICIENT_MAX; // Now 0.100
export const DEFAULT_SHIP_ZOOM_ATTRACT_FACTOR = 0.25;
export const DEFAULT_PLANET_ZOOM_ATTRACT_FACTOR = 0.25;
export const defaultBHGravityFactor = 5.0; // UPDATED - Was 10.0
export const DEFAULT_BH_EVENT_HORIZON_RADIUS = 30;
export const defaultCraterScalingC = CRATER_SCALING_C; // Now 1.0e-1
export const defaultKEToMassEjectEta = KE_TO_MASS_EJECT_ETA;
export const defaultBHEnergyMultiplier = BH_ENERGY_MULTIPLIER;
export const defaultPlanetGravityMultiplier = 15.0; // HUD Value - UPDATED - Was 1.0
